# Практическое задание — Kafka: уведомления в социальной сети
...
## Часть 1 — Продюсер: сервис постов
...
## Часть 2 — Консьюмер: сервис уведомлений
...
func handleEvent(event PostEvent) {
    ...
    // "post_liked"     → "️User %d лайкнул пост %d"
...
## Часть 3 — Запуск через Docker Compose
...
## Часть 4 — Создание топика и проверка
